...
interface MomentFormFieldProps {
  crewName: string;
  momentRegister: ReturnType<typeof useMomentRegister>;
}

function MomentFormField({ momentRegister, crewName }: MomentFormFieldProps) {
  const { formMethods, handleFileInputClick, mergedRef } = momentRegister;
  ...
  return (
    <>
      ...
      <TextInput>
        ...
        <TextInput.Input value={crewName} readOnly={true} />
      </TextInput>
...
export default MomentFormField;
